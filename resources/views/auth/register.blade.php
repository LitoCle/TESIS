                    ...
                    <div class="card-body p-5 text-center">
                      ...
                      <div class="mb-md-5 mt-md-4 pb-5">
                        ...
                        <div data-mdb-input-init class="form-outline form-white mb-4">
                          <input type="text" name="name" class="form-control form-control-lg" placeholder="Ingresa tu nombre"/>
                          <label class="form-label" for="typeNameX">Nombre</label>
                        </div>
                        
                        <div data-mdb-input-init class="form-outline form-white mb-4">
                            <input type="text" name="apellido" class="form-control form-control-lg" placeholder="Ingresa tu apellido"/>
                            <label class="form-label" for="typeApellidoX">Apellido</label>
                          </div>
